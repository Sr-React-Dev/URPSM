...
tjq(window).load(function() {
    ...
    if (enableChaser == 1 && tjq('#content').length > 0 && tjq('#main-menu ul.menu').length > 0) {
        var forchBottom;
        var chaser = tjq('#main-menu ul.menu').clone().hide().appendTo(document.body).wrap("<div class='chaser hidden-mobile scroll-logo-sofyan'><div class='container'></div></div>");
        tjq('<h1 class="logo navbar-brand"><a title="Urpsm" href="/"><img alt="" src="https://urpsm-assets.s3.amazonaws.com/static/v2/images/logo.png"></a></h1>').insertBefore('.chaser .menu');
    ...
    tjq("body").on("click", ".popup-map", function(e) {
        ...
        if (typeof lngltd != "undefined") {
            ...
            var image = {
                url: 'https://urpsm-assets.s3.amazonaws.com/static/v2/images/shop.png',
            ...
            tjq("#soap-map-popup .popup-content").height(contentWidth * 0.5).gmap3({
                ...
                marker: {
                    values: [
                        {latLng: lngltd, options:{icon: image}}
